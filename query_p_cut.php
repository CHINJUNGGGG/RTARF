<?php
    ...
    if(isset($_POST["do"]) && $_POST["do"] != "" ){
        ...
        switch($do){
            case 'modal_edit_p_cut':
                $sql3 = "SELECT 
                j3_rost_transaction.*,COUNT(ROST_ID),
                j1_rank.ROST_CDEP,
                j1_rank.RANK_ID,
                j1_rank.ROST_RANK
            ...
            case 'updatedata_p_cut':
                ...
                $AJY_CUT = $_POST['AJY_CUT'];
                $AJY_KORG = $_POST['AJY_KORG'];

                echo json_encode($AJY_CUT);
                echo json_encode($AJY_KORG);
                //die();
                ...
                //     die();
                // }
                $sql_update = "UPDATE j3_rost_transaction SET AJY_CUT = '$AJY_CUT', AJY_KORG = '$AJY_KORG' WHERE AJY_NUM_ID = '$AJY_NUM_ID' AND ROST_POSNAME_ACM = '$ROST_POSNAME_ACM' AND ROST_RANK = '$ROST_RANK'";
                $stmt3=$db->prepare($sql_update);
                if ($stmt3->execute([$AJY_CUT, $AJY_KORG, $AJY_NUM_ID, $ROST_POSNAME_ACM, $ROST_RANK])){
