<?php
  ...
  header("Content-Disposition: attachment; filename=ตอนที่ 1 กล่าวทั่วไป ".date('d/m/y').".doc");
...
<title>ตอนที่ 1 กล่าวทั่วไป</title>
</head>
<body>
<?php
...
<u>การแบ่งมอบ</u>
<p><?=$ACK_D?></p>
<u>ขอบเขตความรับผิดชอบและหน้าที่</u>
<p><?=$ACK_S?></p>
<u>การแบ่งส่วนราชการและหน้าที่</u>
<p><?=$ACK_DV?></p>
