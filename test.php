							...
							<div class="card">
								<div class="card-body">
									...
									<div id="Home" class="tabcontent">
										...
										<a href="report_ack.php?id=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-danger"><i class="fas fa-file-pdf"></i> กล่าวทั่วไป</button></a><br><br>
										<div class="form-group">
									...
									<div id="Sturc" class="tabcontent">
										<a href="iframe_tree.php?id=<?=$UNIT_CODE_2?>&id2=<?=$ACK_NUM_ID?>" target="_blank" class="btn btn-warning"><i class="fas fa-print"></i> ผังการจัด</a>
										<a href="report_2.php?id=<?=$UNIT_CODE_2?>&id2=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-danger"><i class="fas fa-file-pdf"></i> ผังการจัด</button></a>
										<div style="text-align: center;">
											<br>
													...
													<div id="News" class="tabcontent"> 
														...
														<a href="report_sum_ack_approve.php?id=<?=$UNIT_CODE1;?>&name=<?=$UNIT_CODE1;?>&nickname=<?=$UNIT_CODE1;?>&lastname=<?=$UNIT_CODE1?>&id5=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-primary"><i class="fas fa-file-pdf"></i> อัตรากำลังพลตามตำแหน่ง</button></a>
													    <a href="report_iframe_ack_approve.php?id=<?=$UNIT_CODE1;?>&name=<?=$UNIT_CODE1;?>&nickname=<?=$UNIT_CODE1;?>&lastname=<?=$UNIT_CODE1?>&id5=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-success"><i class="fas fa-file-pdf"></i> สรุปยอดอัตราตามตำแหน่ง</button></a>
													    <a href="report_sum_p_ack_approve.php?id=<?=$UNIT_CODE_2;?>&name=<?=$UNIT_CODE_2;?>&nickname=<?=$UNIT_CODE_2;?>&lastname=<?=$UNIT_CODE_2?>&id5=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-danger"><i class="fas fa-file-pdf"></i> สรุปยอดอัตราตามชั้นยศ</button></a>
													    <br>
														<div class="card-body">
													...
													while($row2=$stmt2->fetch(PDO::FETCH_ASSOC)){
														...
														while($row5=$stmt5->fetch(PDO::FETCH_ASSOC)){
															...
															$sql3 = "SELECT * FROM j3_rost_transaction WHERE ACK_NUM_ID LIKE '".$ACK_NUM_ID."'   
																ORDER BY `j3_rost_transaction`.`ROST_NCPOS12` ASC";
															$stmt3=$db->prepare($sql3);
															$stmt3->execute();
															while($row3=$stmt3->fetch(PDO::FETCH_ASSOC)){
											...
											<div id="Contact" class="tabcontent">
												...
												<a href="report_4.php?id=<?=$ACK_NUM_ID?>"><button type="button" class="btn btn-danger"><i class="fas fa-file-pdf"></i> คำชี้แจง</button></a><br><br>
												<div class="form-group">
											...
											<button type="button" id="add_button" data-toggle="modal" data-target="#modal-xl" class="btn btn-icon btn btn-primary btn-md"><i class="fas fa-plus"></i></button>
												<a href="report_5.php?id=<?=$ACK_NUM_ID;?>"><button type="button" class="btn btn-danger"><i class="fas fa-file-pdf"></i> อัตรายุโธปกรณ์</button></a>
												<div class="card-body">
